...
import 'package:flutter_news_bloc/ui/navigation_drawer/navigation_drawer.dart';
        ...
        countryMenuClick: (events) {
          ...
          switch (events) {
            ...
            case NavigationAction.lngEnglish:
              ...
              break;
            case NavigationAction.lngSpanish:
              MyApp.setLocale(context, const Locale("es"));
              break;
            case NavigationAction.newsPagination:
              Navigator.of(context, rootNavigator: true).pushNamed(
                NewsListPaginationScreen.id,
                arguments: selectedCountries,
              );
              break;
          }
          ...
          if (state is NewsPageLoading) {
            ...
            if ((state.data?.articles ?? []).isNotEmpty == true) {
              ...
              return AppWidgets.getBuildNoResult(
                  context, context.resources.strings?.noNewsFound ?? "");
            }
