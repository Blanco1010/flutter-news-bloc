...
class _CountryListCenterScreenState extends State<CountryListCenterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppWidgets.getAppBarWithSingleIcon(
        context,
        context.resources.strings?.selectCountry ?? "Select Country",
        () {
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText:
                            '${context.resources.strings?.searchCountry ?? 'Search country'}...',
  ...
  Widget _countryGridView() {
    final w =
        (MediaQuery.of(context).size.width) / columns - (spacing * columns) - 1;
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                      width: 4.0,
                      color: countries.code == widget.selectedCountry
                          ? context.resources.color.countrySelectionBorderColor
                          : context.resources.color.colorBG,
                    ),
                  ),
