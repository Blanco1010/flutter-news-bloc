...
class NewsRepoImp extends NewsRepo {
  ...
  @override
  Future getNewsPaginationData(
      String countryCode, String newsType, int page) async {
    try {
      log("MARAJ -->> $countryCode");
      dynamic response = await _apiService.getAllNewsPaginationResponse(
          ApiEndPoints().getNewsList, countryCode, _pageSize, page);
      return response;
    } catch (e) {
      rethrow;
    }
